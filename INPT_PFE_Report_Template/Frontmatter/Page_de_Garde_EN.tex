...
\vspace{0.9cm}
\begin{center}
{\large \textbf{Thesis of the end-of-studies project}}\\[0.1cm]
{\large \textsc{To obtain the State Engineering Diploma}}\\[0.1cm]
{\large \textit{Major: Computer Engineering}} \\[0.05cm] 
\vspace{-0.04cm}
% Title
...
{\large \textit{Defense scheduled for September 2026 before the following jury:}}\\[0.5cm]
