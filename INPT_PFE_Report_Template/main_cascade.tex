...
\hypersetup{
    ...
    pdfsubject={Engineering end-of-study project report},
...
\input{Cascade/Resume}

% \cleardoublepage
%

\input{Cascade/Abstract}

% \cleardoublepage
%

\input{Cascade/ArabicAbstract}
...
\input{Cascade/GeneralIntroduction}

\input{Cascade/ProjectContextAndRequirements}

\input{Cascade/BoardEquivalenceSearch}

\input{Cascade/PilotUsbOptimization}
...
\input{Cascade/ExtendedTI}

\input{Cascade/GeneralConclusion}
